...
p <- ggplot(all_rmse, aes(x=rmse, y=dataset, colour=mod_type, shape=model)) +
  ...
  theme(axis.text.y=element_blank(), panel.grid.major.y=element_line(colour="grey92"),
        legend.position="right")
save_pdf(p, "fig_rmse_empirical", w=7, h=6.5)
